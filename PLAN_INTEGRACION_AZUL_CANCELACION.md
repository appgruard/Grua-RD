...
2.  ~~Actualizar `AzulPaymentService` para asegurar que el método `capturePayment` soporte el envío de montos menores al original (Captura Parcial) y utilice la encriptación SHA512HMAC con la llave proporcionada.~~ (Completado)
